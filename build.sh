...
gcc -m32 -ffreestanding -fno-pie -fno-pic -fno-stack-protector -nostdlib -c Cmds/Help/Info.c -o Info.o
gcc -m32 -ffreestanding -fno-pie -fno-pic -fno-stack-protector -nostdlib -c Cmds/Addr.c -o Addr.o
gcc -m32 -ffreestanding -fno-pie -fno-pic -fno-stack-protector -nostdlib -c Cmds/Programs/Menu.c -o Programs.o
gcc -m32 -ffreestanding -fno-pie -fno-pic -fno-stack-protector -nostdlib -c Programs/Printer.c -o Printer.o
